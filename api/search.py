...
def handler(request):
    ...
    name = query_string.get('name', [''])[0] if isinstance(query_string.get('name'), list) else query_string.get('name', '')
    episode = query_string.get('episode', [''])[0] if isinstance(query_string.get('episode'), list) else query_string.get('episode', '')
    language = query_string.get('language', [''])[0] if isinstance(query_string.get('language'), list) else query_string.get('language', '')
